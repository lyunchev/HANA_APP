sap.ui.define([
	...
	return BaseObject.extend("app.model.GroupSortState", {
		 ...
		 * @alias app.model.GroupSortState
		 */
		...
		/**
		 * Sorts by CONFIRMSTATUS, or by GROSSAMOUNT
		 *
		...
		group: function (sKey) {
			...
			if (sKey === "GROSSAMOUNT") {
				...
				this._oViewModel.setProperty("/sortBy", "CONFIRMSTATUS");
			}
